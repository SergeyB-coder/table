    ...
    <div class="wrap__cntr-selecter">
        <div class="cntr-selecter">
            <div class="cntr-selecter-item box-select">
                <div class="text-2 color-1 ml-8">Доставка 185</div>
            </div>

            <div class="cntr-selecter-item">
                <div class="text-2 color-1 ml-8">Доставка 747</div>
            </div>

            <div class="cntr-selecter-item">
                <div class="text-2 color-1 ml-8">Доставка 222</div>
            </div>

            <div class="cntr-selecter-item">
                <div class="text-2 color-1 ml-8">Доставка 1</div>
            </div>
        </div>
    </div>
</template>
