<template>
    ...
    <modal-filters-net v-show="show_modal_filters" :show_modal_filters="show_modal_filters" />
    <modal-delete v-show="show_modal_delete" />

    <div class="cntr-row">
        <part-left />
        <div class="cntr-bg-2">
            <div @click="() => { show_modal_delete = false; show_modal_is_save = false }"
                v-show="show_modal_delete || show_modal_is_save" class="pseudo_bg"></div>


            <div class="text-1">Тип сети</div>
            <div class="line">
            </div>
            ...
            <div class="segment_menu mt-18 pos-rel">
                ...
                <div @click="() => { config_mode = false; show_modal_is_save = true }" v-show="config_mode"
                    ...
                    <div @click="() => { show_modal = !show_modal; is_settings_mode = false }"
                        class=" text-2 ml-11 cur-pointer">Сохранить</div>
                </div>
                    ...
                    >
                        <td>
                            <div class="cntr-row a-c ">
                                <component :is="net.svg"></component>

                                <label class="ml-8">{{ net.name }}</label>

                                
                            </div>
                            <!-- <select-net v-show="show_table_select_gender" /> -->
                        </td>
                        <td>
                            <div class="cntr-row a-c j-b">
                                <label class="ml-8">{{ net.type }}</label>
                                <svg :class="{ rotate_180: show_selecter_net_list[net.id-1] }"
                                    @click="show_selecter_net_list[net.id-1] = !show_selecter_net_list[net.id-1]" class="td__net_svg_arrow"
                            ...
                            <div v-show="show_selecter_net_list[net.id-1]">

                                <!-- <select-net/> -->
                                <selecter-types 
                                    :interests="['Социальная сеть', 'Тизерная сеть', 'Банерная сеть', 'Нет']" 
                                    :updateVariable="updateVariable(net)"
                                />
...
import MyTarget from '../svg/MyTarget.vue'
import VkSvg from '../svg/VkSvg.vue'
import YandexDir from '../svg/YandexDir.vue'
import DirectAdvert from '../svg/DirAdvert.vue'
import Smi2 from '../svg/SmiSvg.vue'
import MirTesen from '../svg/MirTesen.vue'
import Between from '../svg/BetWeen.vue'
import MobOper from '../svg/MobOper.vue'
import NewsBlock from '../svg/NewsBlock.vue'
import Tizer from '../svg/TizerSvg.vue'
import SelecterTypesNet from './SelecterTypesNet.vue'



export default {
    name: 'SettingsTgChats',
    data() {
        return {
            nets: [
                        { id: 1, name: 'MyTarget', svg: 'svg-mytarget', type: 'нет' },
                        { id: 2, name: 'VK', svg: 'svg-vk', type: 'нет' },
                        { id: 3, name: 'VKv2', svg: 'svg-vk', type: 'нет' },
                        { id: 4, name: 'YandexDirect', svg: 'yandex-dir', type: 'нет' },
                        { id: 5, name: 'DirectAdvert', svg: 'direct-advert', type: 'нет' },
                        { id: 6, name: 'Smi2', svg: 'smi2-svg', type: 'нет' },
                        { id: 7, name: 'МирТесен', svg: 'mir-tesen', type: 'нет' },
                        { id: 8, name: 'Between', svg: 'bet-ween', type: 'нет' },
                        { id: 9, name: 'Мобильные операторы', svg: 'mob-oper', type: 'нет' },
                        { id: 10, name: 'Новостные блоки', svg: 'news-block', type: 'нет' },
                        { id: 11, name: 'Зарубежные тизерные сети', svg: 'tizer-svg', type: 'нет' },
                    ],
            is_check: true,
    ...
    components: {
        ...
        'modal-filters-net': ModalIFiltersNet,
        'select-net': SelecterNet,
        ...
        'selecter-types': SelecterTypesNet,

        // svgs:
        'svg-mytarget': MyTarget,
        'svg-vk': VkSvg,
        'yandex-dir': YandexDir,
