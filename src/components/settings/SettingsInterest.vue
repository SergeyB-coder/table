<template>
    ...
    <div class="cntr-row">
        ...
        <div class="cntr-bg-2">
            ...
            <div class="text-1">Интересы ВК, ВКР, МТ</div>
            <div class="cntr-row sub_menu_ssd">
                ...
                <label class="text__sub_menu_ssd ml-26">Интересы ВК, ВКР и МТ</label>
            </div>
            <div class="line">
            </div>
            ...
            <div class="cntr-table">
                <table class="scroll_table">
                    <tr class="header1 ">
                        ...
                        <th>Поведенческие характеристики МТ</th>
                        <th>Интересы МТ</th>
                        <th>Аудитории МТ</th>
                        <th>Поведенческие характеристики ВК</th>
                    </tr>
