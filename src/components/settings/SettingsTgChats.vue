<template>
    ...
    <modal-filters-interest v-show="show_modal_filters" :show_modal_filters="show_modal_filters" />
    ...
    <div class="cntr-row">
        ...
        <div class="cntr-bg-2">
            ...
            <div class="text-1">Настройка ТГ-чатов</div>
            <div class="line">
            </div>
            ...
            <div class="segment_menu mt-18 pos-rel">
                ...
                <div v-show="config_mode" class="grey-box cntr-row a-c menu_create pos-rel cur-pointer h-40">
                    <svg width="17" height="16" viewBox="0 0 17 16" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <path
                            ...
                            fill="#6B7280" />
                        <path
                            d="M10.6837 8.5H5.35034C5.07701 8.5 4.85034 8.27333 4.85034 8C4.85034 7.72667 5.07701 7.5 5.35034 7.5H10.6837C10.957 7.5 11.1837 7.72667 11.1837 8C11.1837 8.27333 10.957 8.5 10.6837 8.5Z"
                            fill="#6B7280" />
                        <path
                            d="M8.01709 11.1667C7.74376 11.1667 7.51709 10.94 7.51709 10.6667V5.33337C7.51709 5.06004 7.74376 4.83337 8.01709 4.83337C8.29042 4.83337 8.51709 5.06004 8.51709 5.33337V10.6667C8.51709 10.94 8.29042 11.1667 8.01709 11.1667Z"
                            fill="#6B7280" />
                    </svg>
                ...
                <!-- cancel bnt -->
                <div @click="() => { config_mode = false; is_settings_mode = false }" v-show="config_mode"
                    class="grey-box cntr-row a-c menu_cancel pos-rel cur-pointer h-40">
                    <svg width="17" height="16" viewBox="0 0 17 16" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <path
            ...
            <div class="cntr-table">
                <table class="scroll_table">
                    <tr class="header1 ">
                        ...
                        <th>Статус</th>
                        <th>Ссылка на чат МТ</th>
                        <th>ID чата</th>
                        <th>ID бота</th>
                    </tr>

                    <tr v-show="!new_chat" v-for="interest in [
                        { id: 1, interest: 'Интерес 25', behavior: '-', interestMT: '-', audience: '-', field1: '-' },
                        // { id: 2, interest: 'Интерес 25', behavior: '-', interestMT: '-', audience: '-', field1: '-' }
                    ]" v-bind:key="interest.id">
                        <td>
                            <div class="cntr-row a-c">
                                <svg @click="show_modal_delete = true" v-show="is_settings_mode" class="td__svg" width="16"
                                ...
                                <label class="ml-8">{{ interest.interest }}</label>

                                <div class="pos-rel">
                                    <svg v-show="is_settings_mode" :class="{ rotate_180: show_selecter_net }"
                                        @click="show_selecter_net = !show_selecter_net" class="td__svg_arrow" width="16"
                                        height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
                                        <path fill-rule="evenodd" clip-rule="evenodd"
                            ...
                            <select-net v-show="show_selecter_net" />
                        </td>
                        ...
                        <td>
                            <div class="cur-pointer" @click="is_click_link = !is_click_link" :class="{active_color_link: is_click_link}">Ссылка</div>
                        </td>

                        <td>
                            <input class="td_input_interest" placeholder="-" />
                        </td>
                    ...
                    <tr v-show="new_chat">
                        <td>
                            <div class="cntr-row a-c">
                                ...
                                <div class="pos-rel">
                                    <svg v-show="is_settings_mode" :class="{ rotate_180: show_selecter_net1 }"
                                        @click="show_selecter_net1 = !show_selecter_net1" class="td__svg_arrow" width="16"
                                        height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
                                        <path fill-rule="evenodd" clip-rule="evenodd"
                                            d="M1.64592 4.64592C1.69236 4.59935 1.74754 4.56241 1.80828 4.5372C1.86903 4.512 1.93415 4.49902 1.99992 4.49902C2.06568 4.49902 2.13081 4.512 2.19155 4.5372C2.2523 4.56241 2.30747 4.59935 2.35392 4.64592L7.99992 10.2929L13.6459 4.64592C13.6924 4.59943 13.7476 4.56255 13.8083 4.53739C13.8691 4.51223 13.9342 4.49929 13.9999 4.49929C14.0657 4.49929 14.1308 4.51223 14.1915 4.53739C14.2522 4.56255 14.3074 4.59943 14.3539 4.64592C14.4004 4.6924 14.4373 4.74759 14.4624 4.80833C14.4876 4.86907 14.5005 4.93417 14.5005 4.99992C14.5005 5.06566 14.4876 5.13076 14.4624 5.1915C14.4373 5.25224 14.4004 5.30743 14.3539 5.35392L8.35392 11.3539C8.30747 11.4005 8.2523 11.4374 8.19155 11.4626C8.13081 11.4878 8.06568 11.5008 7.99992 11.5008C7.93415 11.5008 7.86903 11.4878 7.80828 11.4626C7.74754 11.4374 7.69236 11.4005 7.64592 11.3539L1.64592 5.35392C1.59935 5.30747 1.56241 5.2523 1.5372 5.19155C1.512 5.13081 1.49902 5.06568 1.49902 4.99992C1.49902 4.93415 1.512 4.86903 1.5372 4.80828C1.56241 4.74754 1.59935 4.69236 1.64592 4.64592Z"
                                            fill="#6B7280" />
                            ...
                            <select-net v-show="show_selecter_net1" />
                        </td>
                        <td><input class="td_input_interest" placeholder="-" /></td>
                        <td><input class="td_input_interest" placeholder="-" /></td>
                        <td><input class="td_input_interest" placeholder="-" /></td>
                        <td><input class="td_input_interest" placeholder="-" /></td>
                    </tr>
...
export default {
    ...
    components: {
        ...
        'modal-filters-interest': ModalIFiltersInterest,
